...
data_analysis/poleMutCharacteristics.R

Figure 2. Model schematic

File

images/inkscape/model_schematics.svg
...
code/modelling/doApproxSimTrajectories.R
(Section: Clone size trajectory plots)

Figure 4. Parameter regimes determining weak versus strong driver dominance
Panel A: Probability of weak/strong clone dominance at fixed population size

Script

code/modelling/doApproxSimsVsAnalytic.R
...
code/modelling/paramRegimesAnalytic.R
(Section: Delta function vs selection parameters)

Panel C: Regimes for emergence of a third driver via weak versus strong driver path

Script

code/modelling/paramRegimesAnalytic.R
(Section: Switch driver between subtypes)
...
data_analysis/plotsStatsKrasAAs.R
...
data_analysis/representativeSpectraMutBurden.R
...
data_analysis/enrichmentWeakStrongDrivers.R
...
data_analysis/fig6DtoHPlotting/postDensMuWeak.R

Input data

reduced_data/simData/20260108.simKrasInf50Ksims.rds

Supplementary Table 1. Summary of studies used

Script

data_analysis/annotatePublicMutData.R

Data

reduced_data/studySummaryTable.csv
